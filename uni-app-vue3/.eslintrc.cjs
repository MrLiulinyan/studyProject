module.exports = {
  ...
  extends: ['eslint:recommended', 'plugin:vue/vue3-recommended', 'plugin:prettier/recommended', './.eslintrc-auto-import.json'],
  ...
  rules: {
    ...
    // "import/no-unresolved": [2, { ignore: ["^@/"] }], // [2, { ignore: ['^@/'] }] @ 是设置的路径别名
